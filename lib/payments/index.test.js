...
describe('payments.js', () => {
  ...
  describe('createIntent()', () => {
    it('should allow to create a payment intent', async () => {
      ...
      expect(await client.payments.intent('stripe', 'premium-offer'))
        .toMatchObject({
          paymentId: 'payment-id',
          intentId: 'payment-intent-id',
        });
  ...
  describe('confirmIntent()', () => {
    it('should allow to confirm a previously created intent', async () => {
      ...
      expect(await client.payments.confirm('stripe', 'payment-id'))
        .toMatchObject({
          payment: {
            id: 'payment-id',
          },
  ...
  describe('setupIntent()', () => {
    it('should allow to create a setup intent (when changing ' +
      ...
      expect(await client.payments.setupIntent('stripe'))
  ...
  describe('updateSource()', () => {
    it('should allow to change a payment method', async () => {
      ...
      expect(await client.payments.updateSource('stripe', 'card-id'))
